...
This is an ESP32-H2 Zigbee CO2 sensor project using a Senseair S8 sensor. Current firmware is **v2.0 (Rust)** in `Rust/`; the legacy Arduino firmware (v1.3) is kept at the repo root.
